# Graph Report - clinical-copilot  (2026-06-18)

## Corpus Check
- 38 files · ~16,063 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 241 nodes · 311 edges · 27 communities (24 shown, 3 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `baf19d3c`
...
8. `run_pipeline()` - 8 edges
9. `check_interactions()` - 7 edges
10. `_fallback_events()` - 6 edges
...
## Knowledge Gaps
- **70 isolated node(s):** `ACCEPTED_TYPES`, `FileEntry`, `FileUploadProps`, `ReportPanelProps`, `Medication` (+65 more)
...
- **What connects `ACCEPTED_TYPES`, `FileEntry`, `FileUploadProps` to the rest of the system?**
